...
import de.chrgroth.quarkus.outbox.domain.startup.PartitionWorkerStarter
...
class PartitionWorkerStarterTests {
  ...
  private val outbox: ExecutionAdapter = mockk()
  private val dispatcher: ApplicationPort = mockk()

  private val recovery = PartitionWorkerStarter(outbox, dispatcher)
